...
<?php include_once 'DB.php'; ?>
    ...
    <title>أعادة تعيين كلمة المرور</title>
    ...
    <?php include_once("header.php"); ?> 
            ...
            <section class="pass-back">
                <form class="pass-form">
                    <p class="pass-text white">تغيير كلمة المرور</p>
                    <div class="contact-input"><input type="password" placeholder="كلمة المرور الجديدة"></div>
                    <div class="contact-input marg-tow"><input type="password" placeholder="أعادة كتابة كلمة المرور الجديدة" ></div>
                  
                    <input type="submit" class="pass-btn btn white" value="تسجيل الدخول" >
