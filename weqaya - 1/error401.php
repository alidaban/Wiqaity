       ...
       <?php include_once("header.php"); ?> 
        ...
        <div class="main-error">
            <div class="right-error">
                <div class="error-fst">الصفحة المطلوبة غير متوفرة حاليا</div>
                    <div class="error-snd">
                        <ul>
                            <li><a href="#">العودة للصفحة السابقة</a></li>
                            <li><a href="#">العودة للصفحة الرئيسية</a></li>
                        </ul>
                    </div>
            </div>
            <div class="error-thd"><div>401</div></div>
