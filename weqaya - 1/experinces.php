...
<?php include_once("header.php"); ?> 
        ...
        <section class="wall">
          <?php 
                    $sql = "SELECT id,title,image,story as content,`date` FROM experiences WHERE `deleted` = 0 LIMIT 5";
...
<!--             page title -->
                <div class="path">
                    ...
                    <a href="#">تجارب اشخاص</a>
                    </div>
                    <!-- end page title -->
                    <?php if(false){ ?>
                    <!-- enter new experienc -->
                    <div class="text-box">
                    <form method="post" action="Controller/add_experince.php">
                        <div class="text-input">
                            <textarea placeholder="تحدث عن تجربة" class="text-area-input text-area-input-wall"></textarea>
                            <a href="#" class="attach-icon"><i class="ion-document-text"><input type="file" class="hide_file"></i></a>
                        </div>
                ...
                <!-- end of entering new experience -->
                <?php } ?>
                ...
                <?php 
                    ...
                    $date = $row['date'];
                    $type = 'expereince';//article/expereince/question
...
<a href="article.php?id=<?php echo $id;?>&type=<?php echo $type; ?>" >قراءة المزيد
        ...
        //get data when click load more
            ...
            $(".btn-load-more").click(function () {
                $.getJSON(
                    'Controller/get_experiences_json.php', //الرابط اللي طالبينه
                    {'init': init }, //sent data
